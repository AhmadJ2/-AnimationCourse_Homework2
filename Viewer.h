...
namespace glfw
{
  ...
  public:
   ...
   // enum class MouseMode { None, Rotation, Zoom, Pan, Translation} mouse_mode;
    ...
    bool activate_moving_objects = false;
    // Scene IO
   ...
   // IGL_INLINE void draw();
    ...
    void draw_boxes(Eigen::AlignedBox<double, 3> box1, Eigen::AlignedBox<double, 3> box2, Eigen::RowVector3d color);
    void addBox(Eigen::AlignedBox<double, 3> box1, Eigen::RowVector3d color);
    bool check_collision_h(igl::AABB<Eigen::MatrixXd, 3> t1, igl::AABB<Eigen::MatrixXd, 3> t2, Eigen::Matrix4f A, Eigen::Matrix4f B);
    IGL_INLINE void animate();
    bool check_collision(Eigen::AlignedBox<double, 3> Box1, Eigen::AlignedBox<double, 3> Box2, Eigen::Matrix4f A, Eigen::Matrix4f B);
